...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        try:
            ...
            from engine_pairs import (engle_granger, compute_spread, zscore,
                PairsConfig, backtest_pair)
            b=read_body(self)
            tk1=b.get("ticker_y","GLD").upper(); tk2=b.get("ticker_x","SLV").upper()
            ...
            send_json(self,{"ticker_y":tk1,"ticker_x":tk2,"dates":dates,
