...
Directly extends engine_mc:
  - Imports SimConfig, black_scholes, implied_vol from engine_mc
...
Usage (same folder as engine_mc.py):
...
from engine_mc import SimConfig, black_scholes, implied_vol
...
# ══════════════════════════════════════════════════════════════════════════
#  BLACK-SCHOLES IV SOLVER  (standalone, faster than engine_mc.implied_vol)
# ══════════════════════════════════════════════════════════════════════════
